#!/usr/bin/env python3
"""
TidyBot2 Pick-and-Place Pipeline (Task 2)
...
from common.constants import YOLO_CLASS_MAP, TAG_MAP, RETRACT_HOLDING_POS
...
class PickAndPlace(PerceptionMixin, GraspMixin, ArmHelpersMixin,
    ...
    def _state_scanning(self):
        ...
        if self._phase == 'object':
            ...
            if det is not None:
                ...
                pos = self._estimate_world_position(u, v, min_depth_override=0.20)
                if pos is not None:
    ...
    def _state_centering(self):
        ...
        if det is not None:
            ...
            min_d_override = 0.20 if self._phase == 'bin' else None
            new_pos = self._estimate_world_position(u, v, min_depth_override=min_d_override)
    ...
    def _state_approaching(self):
        ...
        if det is not None:
            ...
            if self.latest_depth is not None:
                ...
                # For bin approach: scale forward speed by centering
                if self._phase == 'bin':
                    center_fraction = max(
    ...
    def run(self):
        ...
        while rclpy.ok():
            ...
            # Record waypoints during Phase 1
            ...
            # Keep gripper closed during Phase 2
